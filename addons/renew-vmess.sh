...
sed -i "s/### $user $exp/### $user $exp4/g" /usr/local/etc/xray/vmesswstls.json
sed -i "s/### $user $exp/### $user $exp4/g" /usr/local/etc/xray/vmesswsnontls.json
sed -i "s/### $user $exp/### $user $exp4/g" /usr/local/etc/xray/vmessgrpc.json
